...
MATCH (a:Team), (b:Match) WHERE a.name = 'Club Atlético Osasuna' AND b.name = 'Viertelfinale 2' CREATE (a)-[r:PLAYED_IN]->(b)
...
MATCH (a:Spieler), (b:Goal) WHERE a.name = 'Nico Williams' AND b.goalID = 3 CREATE (a)-[r:SCORED]->(b)
MATCH (a:Spieler), (b:Goal) WHERE a.name = 'Álex Berenguer' AND b.goalID = 4 CREATE (a)-[r:SCORED]->(b)
MATCH (a:Spieler), (b:Goal) WHERE a.name = 'Fernando Llorente' AND b.goalID = 5 CREATE (a)-[r:SCORED]->(b)
MATCH (a:Spieler), (b:Goal) WHERE a.name = 'Stoichkov' AND b.goalID = 6 CREATE (a)-[r:SCORED]->(b)
MATCH (a:Spieler), (b:Goal) WHERE a.name = 'Oihan Sancet' AND b.goalID = 7 CREATE (a)-[r:SCORED]->(b)
...
MATCH (a:Goal), (b:Match) WHERE a.goalID = 3 AND b.name = 'Viertelfinale 1' CREATE (a)-[r:IN]->(b)
MATCH (a:Goal), (b:Match) WHERE a.goalID = 4 AND b.name = 'Viertelfinale 1' CREATE (a)-[r:IN]->(b)
MATCH (a:Goal), (b:Match) WHERE a.goalID = 5 AND b.name = 'Viertelfinale 2' CREATE (a)-[r:IN]->(b)
MATCH (a:Goal), (b:Match) WHERE a.goalID = 9 AND b.name = 'Viertelfinale 2' CREATE (a)-[r:IN]->(b)
MATCH (a:Goal), (b:Match) WHERE a.goalID = 10 AND b.name = 'Viertelfinale 2' CREATE (a)-[r:IN]->(b)
